...
align 512, db 0			;being aligned on 512 byres menas we are also aligne don 32 bytes
...
read:
    ...
    pop r9
    push -1 ;Just init as -1  if windows doest write because of eof, it already containt the correct value
    push r9
